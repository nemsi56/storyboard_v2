...
a chron-strip lane-row/offscreen polish pass, and several further rounds of
direct-feedback fixes across the Inspector panel, Braid view, and the Timeline
zoom slider (now a 0-100 auto-fit-aware position shared by both Strip and
Braid, replacing the old fixed 70-200px/scene range); not merged to `main`,
