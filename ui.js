...
const HELP_ZONES = [
  ...
  { sel: '#view-toggle',     tip: 'Cards / Snake / Circle — switch between the card board and either Scene Flow Chart layout. Your last-used chart layout is remembered next time you open one.' },
